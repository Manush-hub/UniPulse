...
<head>
    ...
    <title>e-Ticket - <?= htmlspecialchars((string)($ticket->order_number ?? '')) ?></title>
        <link rel="stylesheet" href="/unipulse/public/assets/css/User/ticket_pdf-style.css">
</head>
<body>
    ...
    <div class="ticket-container">
        ...
        <script src="/unipulse/public/assets/js/User/ticket_pdf-app.js?v=<?= time() ?>"></script>
</body>
</html>