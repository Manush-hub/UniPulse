...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
        <link rel="stylesheet" href="/unipulse/public/assets/css/payhere_redirect-style.css">
</head>
<body>
    ...
    <form id="payhere-checkout" method="POST" action="<?= htmlspecialchars($checkout_url) ?>">
        ...
        <script src="/unipulse/public/assets/js/payhere_redirect-app.js?v=<?= time() ?>"></script>
</body>
</html>
