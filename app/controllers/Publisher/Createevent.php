...
class PublisherCreateevent extends Controller
{
    ...
    {
        $mapping = [
            'faculty-only' => 'faculty-only',           // Faculty Only - most restrictive
            'university-only' => 'university-only',     // University Only - restricted to single university
            'all-universities' => 'all-universities',   // All Universities - visible to all universities
