...
<head>
    ...
    <link rel="stylesheet" href="sponsor.styles.css">
</head>

<body>
    <div class="logo">
      <img src="logo.png" alt="UniPulse Logo">
    </div>
        ...
        <form method="POST" action="">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    ...
                    <input type="number" id="phone-number" name="phone" placeholder="Enter your phone number" required>
                </div>
            </div>
            ...
            <div class="toggle-form">Already have an account? <a href="#">Log in</a>
            </div>
        </form>
    </div>
</body>
