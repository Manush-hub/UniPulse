...
document.addEventListener('DOMContentLoaded', function() {
    console.log('Sponsor Messages Chatbox App initialized');
...
function loadConversation(contactId, contactType, contactName, silent = false) {
    ...
    fetch(`/unipulse/public/sponsor/messages/conversation/${contactId}/${contactType}`)
        .then(response => {
            if (!response.ok) {
...
function sendMessage(event) {
    ...
    fetch('/unipulse/public/sponsor/messages/send', {
        method: 'POST',
        body: formData
    })
