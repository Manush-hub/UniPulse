...
<body>
    ...
    <script>
        ...
        window.userRole = 'Publisher';
        // Convert PHP boosted events data to JavaScript
        const boostedEventsFromDB = <?php echo json_encode($boosted_events ?? []); ?>;
    </script>
    <script src="/unipulse/public/assets/js/shared/landing-app.js"></script>
    <?php 
    $overridePath = '/unipulse/public/assets/js/overrides/Publisher/landing-app-overrides.js';
    if (file_exists($_SERVER['DOCUMENT_ROOT'] . $overridePath)): ?>
        <script src="<?php echo $overridePath; ?>"></script>
    <?php endif; ?>
</body>
</html>
