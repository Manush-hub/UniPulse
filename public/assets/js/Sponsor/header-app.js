...
function loadUserData() {
    document.getElementById('username').textContent = sponsorData.username;
    // document.getElementById('welcomeUsername').textContent = sponsorData.displayName;
}
...
function setupEventListeners() {
    ...
    document.addEventListener('click', function(e) {
        ...
        if (!e.target.closest('.sponsor-menu')) {
...
function toggleUserMenu() {
    const dropdown = document.getElementById('sponsorDropdown');
    dropdown.classList.toggle('show');
}
