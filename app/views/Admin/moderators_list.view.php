...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
        <link rel="stylesheet" href="/unipulse/public/assets/css/Admin/moderators_list-style.css">
</head>
<body>
    <!-- Header -->
    <!-- <header class="header">
    ...
    <div id="deleteModal" class="delete-modal" style="display: none;">
        ...
        <div class="modal-content">
            ...
            <script src="/unipulse/public/assets/js/Admin/moderators_list-app.js?v=<?= time() ?>"></script>
</body>
</html>
