...
<head>
    ...
    <link rel="stylesheet" href="/unipulse/public/assets/css/Moderator/publisher_approval-style.css">
</head>
...
<body>
    ...
    <div id="confirmationModal" class="modal">
        <div class="modal-content">
            ...
            <script src="/unipulse/public/assets/js/Moderator/publisher_approval-app.js?v=<?= time() ?>"></script>
</body>
