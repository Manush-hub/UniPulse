...
const recentActivity = [
    ...
    },
    {
        id: 2,
        type: 'created',
        title: 'Created Study Group Session',
        description: 'Your study group event has been published',
        time: '1 day ago',
        icon: 'plus'
    },
    {
    ...
    },
    {
        ...
        description: 'Earned "Event Enthusiast" badge',
        time: '3 days ago',
        icon: 'award'
    }
];
...
function loadUserData() {
    ...
    document.getElementById('upcomingEvents').textContent = userData.upcomingEvents;
    document.getElementById('eventsCreated').textContent = userData.eventsCreated;
}
