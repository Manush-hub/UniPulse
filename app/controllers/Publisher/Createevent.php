    ...
    private function handleFormSubmission()
    {
        ...
        try {
            ...
            $formData = [
                ...
                'donation_bank_name' => $_POST['donation_bank_name'] ?? null,
                'donation_account_name' => $_POST['donation_account_name'] ?? null,
                'donation_account_number' => $_POST['donation_account_number'] ?? null,
                'donation_branch' => $_POST['donation_branch'] ?? null,
                'donation_swift_code' => $_POST['donation_swift_code'] ?? null,
                'donation_instructions' => $_POST['donation_instructions'] ?? null,
