...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
        <link rel="stylesheet" href="/unipulse/public/assets/css/Admin/moderator_create-style.css">
</head>
<body>
    <!-- Header -->
    <!-- <header class="header">
    ...
    <div class="main-container">
        ...
        <script src="/unipulse/public/assets/js/Admin/moderator_create-app.js?v=<?= time() ?>"></script>
</body>
</html>
