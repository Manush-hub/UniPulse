...
class PublisherDeleteevent extends Controller{
    ...
    public function index($eventId = '', $b = '' , $c = ''){
        ...
        if (!AuthService::isLoggedIn() || AuthService::getCurrentUser()['type'] !== 'publisher') {
            ...
            if (!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
                ...
                echo json_encode([
                    'success' => false,
                    'errors' => ['general' => 'You must be logged in as a publisher to delete events. Please login and try again.'],
        ...
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            ...
            header('Location: /unipulse/public/publisher/events?error=Invalid request method');
            exit();
        }
        ...
        try {
            ...
            if ($result['success']) {
                ...
                if ($isAjax) {
                    ...
                    header('Location: /unipulse/public/publisher/events?success=Event deleted successfully');
                    exit();
                }
            } else {
                ...
                if ($isAjax) {
                    ...
                    header('Location: /unipulse/public/publisher/events?error=' . urlencode($errorMessage));
                    exit();
                }
            }
            ...
            if ($isAjax) {
                ...
                header('Location: /unipulse/public/publisher/events?error=' . urlencode('Server error occurred'));
                exit();
            }
        }
    }
