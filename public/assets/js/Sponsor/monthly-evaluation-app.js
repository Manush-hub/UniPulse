(function () {
    ...
    if (!monthPicker || !downloadBtn || !totalRequests || !approvedRequests || !pendingRequests || !committedAmount || !approvalRate || !recordsBody) {
        return;
    }

    const defaultMonth = (window.sponsorMonthlyEvaluationConfig && window.sponsorMonthlyEvaluationConfig.defaultMonth) || '';
